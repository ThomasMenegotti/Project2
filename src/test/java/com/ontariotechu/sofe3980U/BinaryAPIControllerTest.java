...
public class BinaryAPIControllerTest {
    ...
    public void or() throws Exception {
        this.mvc.perform(get("/bitwiseOr").param("operand1", "111").param("operand2", "1010"))// .andDo(print())
                .andExpect(status().isOk())
    ...
    public void or2() throws Exception {
        this.mvc.perform(get("/bitwiseOr_json").param("operand1", "111").param("operand2", "1010"))// .andDo(print())
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.operand1").value(111))
                .andExpect(MockMvcResultMatchers.jsonPath("$.operand2").value(1010))
    ...
    public void and() throws Exception {
        this.mvc.perform(get("/bitwiseAnd").param("operand1", "111").param("operand2", "1010"))// .andDo(print())
                .andExpect(status().isOk())
    ...
    public void and2() throws Exception {
        this.mvc.perform(get("/bitwiseAnd_json").param("operand1", "111").param("operand2", "1010"))// .andDo(print())
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.operand1").value(111))
                .andExpect(MockMvcResultMatchers.jsonPath("$.operand2").value(1010))
    ...
    public void multi2() throws Exception {
        this.mvc.perform(get("/multiply_json").param("operand1", "111").param("operand2", "1010"))// .andDo(print())
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$.operand1").value(1110000))
                .andExpect(MockMvcResultMatchers.jsonPath("$.operand2").value(1010))
